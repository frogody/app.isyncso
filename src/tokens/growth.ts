// GROWTH Design Tokens
// Growth/CRM Module - Design System Specification
...
export const GROWTH_COLORS = {
  primary: {
    ...
    shade: '#4F46E5',   // indigo-600
    light: '#818CF8',   // indigo-400
    tint10: 'rgba(99, 102, 241, 0.1)',
    tint15: 'rgba(99, 102, 241, 0.15)',
    tint20: 'rgba(99, 102, 241, 0.2)',
  },
} as const;

// ─── Component Tokens ─────────────────────────────────────

export const GROWTH_BUTTON_STYLES = {
  sizes: {
    sm: 'h-8 px-4 text-xs',
  ...
  variants: {
    primary: 'bg-indigo-500 text-white hover:bg-indigo-400 active:bg-indigo-600 disabled:bg-indigo-500/50 disabled:cursor-not-allowed rounded-full transition-colors duration-200',
...
export const GROWTH_CARD_STYLES = {
...
export const GROWTH_BADGE_STYLES = {
