...
// Settings Module - Design System Specification
...
export const SETTINGS_BUTTON_STYLES = {
  ...
  variants: {
    primary: 'bg-cyan-500 text-white hover:bg-cyan-400 active:bg-cyan-600 disabled:bg-cyan-500/50 disabled:cursor-not-allowed rounded-full transition-colors duration-200',
...
export const SETTINGS_BADGE_STYLES = {
