...
export const DEFAULT_STORE_CONFIG = {
  ...
  seo: { ...DEFAULT_SEO },
  sections: [
    createDefaultSection('banner', 0),
    createDefaultSection('hero', 1),
    { ...createDefaultSection('stats', 2), background: 'alt' },
    createDefaultSection('featured_products', 3),
    { ...createDefaultSection('category_grid', 4), background: 'alt' },
    createDefaultSection('about', 5),
    { ...createDefaultSection('testimonials', 6), background: 'alt' },
    createDefaultSection('faq', 7),
    { ...createDefaultSection('cta', 8), background: 'primary' },
