...
import ClickDiagram from '../animations/ClickDiagram';

export default function InteractionGuidePage({ formData, onNext, onBack }) {
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] px-4 text-center">
      ...
      {/* Title */}
      <h1 className="text-3xl sm:text-4xl font-bold text-white mb-3">How to Interact</h1>
      {/* Subtitle */}
      <p className="text-zinc-400 text-sm sm:text-base max-w-md mb-10">
        Three simple gestures for everything.
      </p>
      {/* Buttons */}
