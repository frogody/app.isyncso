          ...
          <div>
            ...
            {painPoints.length > 2 && (
              <button
                ...
                className="flex items-center gap-1 text-xs text-amber-400 hover:text-amber-300 mt-2 transition-colors"
              >
          ...
          <div className={painPoints.length > 0 ? "pt-3 border-t border-zinc-700/30" : ""}>
            ...
            <div className="flex flex-wrap gap-2">
              {displayOpps.map((opp, i) => (
                <span
                  key={i}
                  className="px-2.5 py-1 bg-green-500/10 text-green-300 rounded-lg text-xs border border-green-500/20"
                >
                  {formatOpp(opp)}
                </span>
              ))}
            ...
            {lateralOpps.length > 3 && (
              <button
                ...
                className="flex items-center gap-1 text-xs text-green-400 hover:text-green-300 mt-2 transition-colors"
              >
