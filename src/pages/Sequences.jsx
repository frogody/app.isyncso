      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              >
                ...
                <div className="grid grid-cols-3 gap-4">
                  <div className="text-center p-3 bg-zinc-800/50 rounded-lg">
                    <div className="text-lg font-bold text-white">{seq.openRate}%</div>
                    <div className="text-xs text-zinc-500">Open Rate</div>
                  </div>
                  <div className="text-center p-3 bg-zinc-800/50 rounded-lg">
                    <div className="text-lg font-bold text-white">{seq.replyRate}%</div>
                    <div className="text-xs text-zinc-500">Reply Rate</div>
                  </div>
                  <div className="text-center p-3 bg-zinc-800/50 rounded-lg">
                    <div className="text-lg font-bold text-orange-400">{seq.contacts}</div>
          ...
          <div className="bg-zinc-900/50 border border-zinc-800 rounded-xl p-6">
            <h3 className="text-lg font-semibold text-white mb-4">Sequence Steps</h3>
            <div className="space-y-3">
              {steps.map((step, i) => (
                <motion.div
                  ...
                  className="flex items-center gap-3 p-3 bg-zinc-800/50 border border-zinc-700 rounded-lg hover:border-orange-500/50 transition-colors group"
                >
                  ...
                  <button className="p-1.5 hover:bg-zinc-700 rounded opacity-0 group-hover:opacity-100 transition-opacity">
                    <Edit className="w-3 h-3 text-zinc-400" />
                  </button>
                </motion.div>
              ))}
              <button className="w-full p-3 border border-dashed border-zinc-700 rounded-lg text-sm text-zinc-500 hover:border-orange-500 hover:text-orange-400 transition-colors flex items-center justify-center gap-2">
                <Plus className="w-4 h-4" />
                Add Step
              </button>
            </div>
          ...
          >
            ...
            >
              <div className="flex items-center justify-between mb-6">
                <h3 className="text-lg font-semibold text-white">Create Sequence</h3>
                <button onClick={() => setShowEditor(false)} className="p-2 hover:bg-zinc-800 rounded-lg">
