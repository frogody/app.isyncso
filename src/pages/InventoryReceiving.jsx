...
import {
  ...
  Warehouse, MapPin, CheckCircle2, AlertCircle
} from "lucide-react";
...
// Barcode scanner component (simplified - in production use a proper library)
      ...
      <div className="relative">
        ...
        <div className="p-8 border-2 border-dashed border-cyan-500/30 rounded-xl bg-cyan-500/5 text-center">
          ...
          <p className="text-zinc-400 text-sm">
            Scan barcode of typ EAN-code handmatig in
          </p>
        </div>
      </div>
