        ...
        <div className="p-4">
          <div className="flex items-start gap-3">
            ...
            <div className={`w-8 h-8 rounded-xl flex items-center justify-center flex-shrink-0 ${
              ...
              <Icon className={`w-4 h-4 ${isPast ? 'text-[#86EFAC]' : 'text-zinc-500'}`} />
            </div>
      ...
      <div className="p-4 rounded-xl bg-zinc-900/50 border border-zinc-800/60">
        <div className="flex items-start justify-between mb-3">
          ...
          <div className="text-right">
            <div className="text-xl font-bold text-[#86EFAC]/80">{Math.round(item.progress)}%</div>
...
function UrgentTaskCard({ task, index }) {
  return (
    <motion.div
      ...
      transition={{ delay: index * 0.05 }}
    >
      <div className={`relative bg-zinc-900/60 backdrop-blur-sm rounded-xl border p-4 ${
      ...
      <div className="w-full px-4 lg:px-6 py-4 space-y-4">
        ...
        <AnimatePresence>
          {aiRecommendations && (
            <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }}>
              <div className="p-4 rounded-xl bg-zinc-900/50 border border-zinc-800/60 bg-gradient-to-br from-[#86EFAC]/5 to-transparent">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <h4 className="text-xs font-semibold text-[#86EFAC] mb-3 flex items-center gap-2">
                  ...
                  <div>
                    <h4 className="text-xs font-semibold text-[#6EE7B7] mb-3 flex items-center gap-2">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-5 gap-3">
          <div className="p-4 rounded-xl bg-zinc-900/50 border border-zinc-800/60">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-lg font-bold text-white mt-1">{stats.allTasks.length}</p>
              </div>
          ...
          <div className="p-4 rounded-xl bg-zinc-900/50 border border-zinc-800/60">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-lg font-bold text-white mt-1">{stats.overdueTasks}</p>
              </div>
              <div className="w-8 h-8 rounded-xl bg-[#86EFAC]/20 flex items-center justify-center">
          ...
          <div className="p-4 rounded-xl bg-zinc-900/50 border border-zinc-800/60">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-zinc-500 text-xs">Urgent (90d)</p>
                <p className="text-lg font-bold text-white mt-1">{stats.urgentTasks.length}</p>
              </div>
              <div className="w-8 h-8 rounded-xl bg-[#86EFAC]/15 flex items-center justify-center">
                <Zap className="w-4 h-4 text-[#86EFAC]/60" />
              </div>
            </div>
          </div>
          ...
          <div className="p-4 rounded-xl bg-zinc-900/50 border border-zinc-800/60">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-lg font-bold text-white mt-1">{stats.completedTasks}</p>
              </div>
              <div className="w-8 h-8 rounded-xl bg-[#86EFAC]/15 flex items-center justify-center">
          ...
          <div className="p-4 rounded-xl bg-zinc-900/50 border border-zinc-800/60">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-lg font-bold text-white mt-1">{stats.progressPercent}%</p>
              </div>
              <div className="w-8 h-8 rounded-xl bg-[#86EFAC]/15 flex items-center justify-center">
                <TrendingUp className="w-4 h-4 text-[#86EFAC]/60" />
              </div>
            </div>
          </div>
        </div>
          ...
          <TabsContent value="systems" className="mt-4">
            {stats.systemProgress.length === 0 ? (
              <div className="p-16 text-center rounded-xl bg-zinc-900/50 border border-zinc-800/60">
                <div className="w-20 h-20 rounded-xl bg-gradient-to-br from-[#86EFAC]/20 to-[#6EE7B7]/20 flex items-center justify-center mx-auto mb-6">
