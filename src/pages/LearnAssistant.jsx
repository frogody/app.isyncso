...
export default function LearnAssistant() {
  ...
  // Get personalized quick actions based on user profile
  const getQuickActions = () => {
    ...
    // Build role-specific course prompt
