...
7. CREDIT ESTIMATION - Image generation uses Nano Banana Pro (Google Gemini API, ~$0.14/image real cost). Users pay in credits: 12 credits per image (~€1). Costs per action: replace_image = 12 credits, copy = 2 credits, seo = 1 credit (0 if bundled with copy action), image (new USP visual) = 12 credits each.
...
- "seo" action: Include if the SEO / Discoverability category scored below 80. Set credits to 0 if a "copy" action already exists (they run together), otherwise 1 credit.
