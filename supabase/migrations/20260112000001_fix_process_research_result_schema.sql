-- Fix process_research_result to work with stock_purchases schema
-- Removes INSERT into stock_purchases (which was for old expenses schema)
-- Updates stock_purchase_line_items.product_id instead
