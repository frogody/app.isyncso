-- Update process_research_result to set tagline, featured_image, and gallery on products
...
BEGIN
  ...
  IF v_existing_product_id IS NOT NULL THEN
    -- Product exists - update images if not set, then create stock purchase
    UPDATE products SET
