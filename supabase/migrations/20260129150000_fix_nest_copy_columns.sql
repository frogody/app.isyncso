-- ==================================================
-- FIX: copy_nest_to_organization column names and missing fields
-- - years_experience → experience_years (matches schema)
-- - Add work_history, interests, inferred_skills to copy
-- ==================================================
...
BEGIN
  ...
  FOR v_item IN
    SELECT ni.*,
           ...
           c.company_name as c_company, c.skills as c_skills, c.experience_years as c_experience,
           ...
           c.work_history as c_work_history, c.interests as c_interests, c.inferred_skills as c_inferred_skills,
    ...
    BEGIN
      IF v_item.candidate_id IS NOT NULL THEN
        ...
        INSERT INTO candidates (
          ...
          job_title, company_name, skills, experience_years, education, languages,
          certifications, person_home_location, profile_image_url,
          work_history, interests, inferred_skills,
          source, source_url, created_date, updated_date
        ) VALUES (
          ...
          v_item.c_work_history, v_item.c_interests, v_item.c_inferred_skills,
      ...
      ELSIF v_item.investor_id IS NOT NULL THEN
        -- Skip investors for now (no target table)
        v_copied_count := v_copied_count + 1;
      END IF;
  ...
  -- Queue all new candidates for intelligence generation
